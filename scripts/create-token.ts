...
async function createToken() {
    ...
    //   });
    const connection = new Connection("https://api.testnet.solana.com", {commitment: "confirmed"});
    ...
    const amount = 1_000_000_000_000_000 // 1,000,000 token  
    // Create token mint with 9 decimals
    const mintAccount = await createMint(connection, signer, signer.publicKey, signer.publicKey, 6)
