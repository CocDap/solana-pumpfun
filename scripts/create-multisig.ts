...
const user1 = getKeypairFromFile(`${os.homedir()}/.config/solana/id.json`);
const user2 = getKeypairFromFile(`${os.homedir()}/.config/solana/id2.json`);
const user3 = getKeypairFromFile(`${os.homedir()}/.config/solana/id3.json`);
